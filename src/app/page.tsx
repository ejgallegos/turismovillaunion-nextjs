  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="flex items-end justify-between mb-12">
              <div>
                ...
                <h3 className="text-4xl md:text-5xl font-black tracking-tight">Destinos Destacados</h3>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {featuredAttractions.map((attraction) => (
                <Link href={`/atractivos/${attraction.id}`} key={attraction.id} className="group relative h-[500px] rounded-xl overflow-hidden shadow-2xl transition-transform hover:-translate-y-2">
                  <Image
                  ...
                  <div className="absolute bottom-0 left-0 p-8">
                    <h4 className="text-white text-2xl font-bold mb-2">{attraction.title}</h4>
                    ...
                    <span className="bg-white/20 hover:bg-white text-white hover:text-primary px-4 py-2 rounded-lg text-xs font-bold transition-colors inline-block">
                      Ver más
                    </span>
                  </div>
                </Link>
              ...
              {featuredAttractions.length === 0 && (
                <>
                  <div className="group relative h-[500px] rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent" />
                    <div className="absolute bottom-0 left-0 p-8">
                      <h4 className="text-white text-2xl font-bold mb-2">Parque Nacional Talampaya</h4>
                  ...
                  <div className="group relative h-[500px] rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent" />
                    <div className="absolute bottom-0 left-0 p-8">
                      <h4 className="text-white text-2xl font-bold mb-2">Ischigualasto</h4>
                  ...
                  <div className="group relative h-[500px] rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent" />
                    <div className="absolute bottom-0 left-0 p-8">
                      <h4 className="text-white text-2xl font-bold mb-2">Cañón del Triásico</h4>
        ...
        {/* Experiences Section */}
        <section className="w-full bg-primary/5 rounded-xl p-12 md:p-20 mx-4 md:mx-10 my-8">
          <div className="text-center mb-16">
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">Vive la Región</h2>
            <h3 className="text-4xl md:text-5xl font-black tracking-tight">Experiencias Inolvidables</h3>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <div className="bg-white dark:bg-background-dark p-8 rounded-xl shadow-sm border border-primary/10 hover:border-primary transition-colors text-center group">
            ...
            <div className="bg-white dark:bg-background-dark p-8 rounded-xl shadow-sm border border-primary/10 hover:border-primary transition-colors text-center group">
              <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                <Wine className="text-4xl" />
              </div>
              <h5 className="text-xl font-bold mb-3">Enoturismo</h5>
            ...
            <div className="bg-white dark:bg-background-dark p-8 rounded-xl shadow-sm border border-primary/10 hover:border-primary transition-colors text-center group">
              <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                <Footprints className="text-4xl" />
              </div>
              <h5 className="text-xl font-bold mb-3">Trekking</h5>
            ...
            <div className="bg-white dark:bg-background-dark p-8 rounded-xl shadow-sm border border-primary/10 hover:border-primary transition-colors text-center group">
              <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                <Car className="text-4xl" />
              </div>
              <h5 className="text-xl font-bold mb-3">Aventura</h5>
        ...
        <section className="w-full py-24 md:py-32">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="mb-12">
              ...
              <h3 className="text-4xl md:text-5xl font-black tracking-tight">Planifica Tu Viaje</h3>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Alojamiento Card */}
              <div className="bg-primary/5 dark:bg-primary/20 p-10 rounded-xl flex flex-col justify-between h-[400px]">
                <div>
                  ...
                  <h4 className="text-2xl font-bold mb-4">Alojamiento</h4>
                  <p className="text-slate-600 dark:text-slate-300">Encontrá el alojamiento perfecto, desde hoteles boutique hasta cabañas rústicas en el corazón del valle.</p>
                </div>
                <Button asChild className="flex items-center gap-2 font-bold text-primary group bg-transparent hover:bg-transparent p-0">
                  <Link href="/servicios">
              ...
              {/* Gastronomía Card */}
              <div className="bg-primary/10 dark:bg-primary/30 p-10 rounded-xl flex flex-col justify-between h-[400px]">
                <div>
                  <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mb-6">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h4 className="text-2xl font-bold mb-4">Gastronomía</h4>
                  <p className="text-slate-600 dark:text-slate-300">Probá los sabores auténticos de La Rioja. Empanadas tradicionales, locro y el mejor Torrontés.</p>
                </div>
                <Button asChild className="flex items-center gap-2 font-bold text-primary group bg-transparent hover:bg-transparent p-0">
                  <Link href="/servicios">
              ...
              <Link href="/mapa-interactivo" className="relative overflow-hidden rounded-xl h-[400px] group">
                <Image 
                  alt="Mapa Regional" 
                  ...
                  sizes="(max-width: 768px) 100vw, 33vw"
                />
                <div className="absolute inset-0 bg-primary/40 backdrop-blur-[2px] p-10 flex flex-col justify-between">
                  <div>
                    <div className="w-16 h-16 bg-white/20 text-white rounded-full flex items-center justify-center mb-6">
                      <MapPin className="w-8 h-8" />
                    </div>
                    <h4 className="text-2xl font-bold mb-4 text-white">Mapa Interactivo</h4>
                    <p className="text-white/90">Encontrá los principales atractivos, miradores y estaciones de servicio de la región.</p>
                  </div>
                  <Button className="bg-white text-primary px-6 py-3 rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-accent hover:text-white transition-colors w-full">
